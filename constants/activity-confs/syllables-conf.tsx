          ...
          second: {
            ...
            reference: (
              <>
                <a
                  rel="noreferrer"
                  href="https://www.freepik.com/free-vector/cute-grandmother-reading-book-sofa-cartoon-vector-icon-illustration-people-education-isolated_32669688.htm#query=grandma&position=29&from_view=search&track=robertav1"
                >
          ...
          second: {
            ...
            reference: (
              <>
                ...
                <a
                  rel="noreferrer"
                  href="https://www.freepik.com/free-vector/sheeps-goats-illustration_791924.htm#page=5&query=ram%20animal%20drawing%20sheep&position=0&from_view=search&track=robertav1"
                >
                  Freepik
                </a>
              </>
          ...
          first: {
            ...
            reference: (
              <>
                <a
                  rel="noreferrer"
                  href="https://www.freepik.com/free-vector/farm-animals-cartoon-icons-set-hen-gobbler-cow-horse-ram-cat-bunny-isolated-vector-illustration_4188523.htm#query=farm%20animals&position=1&from_view=search&track=sph"
                >
          ...
          second: {
            ...
            reference: (
              <>
                <a
                  rel="noreferrer"
                  href="https://www.freepik.com/free-vector/cartoon-rabbits-set_9649167.htm#query=bunny&position=19&from_view=search&track=robertav1"
                >
                  Image by pch.vector
                </a>{' '}
                on Freepik
          ...
          second: {
            ...
            reference: (
              <>
                <a
                  rel="noreferrer"
                  href="https://www.freepik.com/free-vector/wooden-marble-stone-rolling-pins-vector_5900544.htm#page=6&query=baking%20tools&position=3&from_view=search&track=robertav1"
                >
