...
const wordDiffConf = {
    training: {
        ...
        reference: (
            <>
                <a rel="noreferrer" href="https://www.freepik.com/icon/conference_7185806#fromView=keyword&term=Presentation&page=1&position=69&uuid=7022f7fe-aaa0-4978-93da-54a37f450ff7">
                    Image by Freepik
                </a>{' '}
                on Freepik
            </>
    ...
    iceCube: {
        ...
        reference: (
            <>
                <a rel="noreferrer" href="https://www.freepik.com/icon/ice-cube_2458102">
                    Image by Freepik
                </a>{' '}
                on Freepik
            </>
    ...
    archery: {
        ...
        reference: (
            <>
                <a rel="noreferrer" href="https://www.freepik.com/free-vector/crossed-arrows-vector-illustration-medieval-weapon-war-battle-accessory_11235613.htm#query=archer%20weapon&position=3&from_view=keyword&track=ais&uuid=a069751f-6c26-4fe8-8cea-c12ad37d8a3c">
                    Image by pch.vector
                </a>{' '}
                on Freepik
            </>
    ...
    groupOfMen: {
        ...
        reference: (
            <>
                <a rel="noreferrer" href="https://www.freepik.com/icon/teamwork_2583237#fromView=search&term=group-of-men&track=ais&page=1&position=0&uuid=4f4e0fb1-b87d-4f04-9bab-bc8f568e9930">
                    Image by Freepik
                </a>{' '}
                on Freepik
            </>
    ...
    hourglass: {
        ...
        reference: (
            <>
                <a rel="noreferrer" href="https://www.freepik.com/icon/hourglass_3073484#fromView=resource_detail&position=28">
                    Image by Freepik
                </a>{' '}
                on Freepik
            </>
    ...
    pouring: {
        ...
        reference: (
            <>
                <a rel="noreferrer" href="https://www.freepik.com/icon/pouring_7923244#fromView=resource_detail&position=6">
                    Image by Freepik
                </a>{' '}
                on Freepik
            </>
    ...
    roseHip: {
        ...
        reference: (
            <>
                <a rel="noreferrer" href="https://www.freepik.com/icon/rose-hip_5402444#fromView=resource_detail&position=3">
                    Image by popo2021
                </a>{' '}
                on Freepik
            </>
    ...
    scales: {
        ...
        reference: (
            <>
                <a rel="noreferrer" href="https://www.freepik.com/free-vector/vintage-scale-design_1029758.htm">
    ...
    spring: {
        ...
        reference: (
            <>
                <a rel="noreferrer" href="https://www.freepik.com/icon/extension_565505">
                    Image by Google
                </a>{' '}
                on Freepik
            </>
    ...
    zipperTool: {
        ...
        reference: (
            <>
                <a rel="noreferrer" href="https://www.freepik.com/icon/zipper_3461269#fromView=search&term=zipper-tool&track=ais&page=1&position=39&uuid=003deeac-8b2e-414e-9cd4-9bb500e400f1">
                    Image by iconixar
                </a>{' '}
                on Freepik
            </>
