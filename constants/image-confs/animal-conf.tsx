  ...
  snake: {
    ...
    reference: (
      <>
        <a
          rel="noreferrer"
          href="https://www.freepik.com/free-vector/snakes-wild-tropical-serpents-isolated-white_13778464.htm#query=snake&position=11&from_view=search&track=sph"
        >
          Image by upklyak
        </a>{' '}
        on Freepik
  ...
  fly: {
    ...
    reference: (
      <>
        <a
          rel="noreferrer"
          href="https://www.freepik.com/free-vector/design-with-seamless-pattern-housefly_7033958.htm#query=fly&position=18&from_view=search&track=sph"
        >
          Image by brgfx
        </a>{' '}
        on Freepik
  ...
  elephant: {
    ...
    reference: (
      <>
        <a
          rel="noreferrer"
          href="https://www.freepik.com/free-vector/cute-baby-elephant-butterfly-outline-drawing-color_7038521.htm#query=elephant&position=5&from_view=search&track=sph"
        >
          Image by user2104819
        </a>{' '}
        on Freepik
      </>
    ),
